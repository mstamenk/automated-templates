...
# Commented lines used as flag for automatic writing, do not delete or alter
...
# Specific to the example2: 
# Update the file Analysis.hpp every time you import routines.Analysis
